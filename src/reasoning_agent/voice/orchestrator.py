...
from reasoning_agent.voice.classifier import CommandClassifier, CommandKind
...
from reasoning_agent.voice.timing import TimingCollector, TurnTiming
...
from reasoning_agent.voice.voice_display import VoiceDisplay
...
class VoiceOrchestrator:
    ...
    async def handle_speech_segment(self, audio_bytes: bytes) -> None:
        ...
        if self._classifier is not None:
            ...
            from reasoning_agent.voice.types import CommandDecision
